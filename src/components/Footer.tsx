  ...
  return(
    <div className={styles.footerContainer}>
      ...
      <div className={styles.openContainer}>
        <ul>
        <li><span><CalendarDots size={22} color='#F2F4F7'/></span>Segunda à Sexta-Feira das 09h00 às 17h00.</li>
        <li><span><CalendarX size={22} color='#F2F4F7'/></span>Sábados, Domingos e Feriados Fechado.</li>
        </ul>
      </div>
    </div>
  )
